...
public:
    ...
    static std::string getPythonStringfixed(std::shared_ptr<SteinerTreeNode> node);
};
...
public:
    ...
    static std::string getPythonStringfixed(std::shared_ptr<PatternRoutingNode> routingDag);
};
...
public:
    ...
    void constructRoutingDAGfixed(std::vector<int>& ChoosedPatternIndexArray,int& TwoPinNetInedex);
...
private:
    ...
    void constructPathsfixed(std::shared_ptr<PatternRoutingNode>& start, std::shared_ptr<PatternRoutingNode>& end,std::vector<int>& ChoosedPatternIndexArray,int& TwoPinNetInedex, int childIndex = -1);
