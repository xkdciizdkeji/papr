...
public:
    ...
    MetalLayer(const Rsyn::PhysicalLayer& rsynLayer, const std::vector<Rsyn::PhysicalTracks>& rsynTracks, const DBU libDBU);
...
private:
    ...
    std::vector<std::vector<DBU>> parallelSpacing = {{0}}; // width, length -> spacing
