...
MetalLayer::MetalLayer(const std::string name, const int layerDirection, const int layerMinLengths, const int layerIndex) {
    this->name = name;
    this->index = layerIndex;
    this->direction = layerDirection;
    this->minLength = layerMinLengths;
}
